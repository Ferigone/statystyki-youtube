...
import { filterVideosWithChannelNames } from '@/utils';
  ...
  if (file && file.name.endsWith('.json')) {
    ...
    reader.onload = (event) => {
      ...
      if (typeof result === 'string') {
        ...
        historyStore.setHistory(filterVideosWithChannelNames(json));
      }
    };
  }
};
...
<template>
  <h1 class="text-4xl font-black mb-8">Statystyki YouTube</h1>
